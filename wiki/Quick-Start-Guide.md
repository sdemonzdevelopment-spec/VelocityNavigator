...
1. Download `VelocityNavigator-4.2.0.jar` from the [Releases](https://github.com/sdemonzdevelopment-spec/VelocityNavigator/releases) page
...
**Total time: ~5 minutes. Welcome to VelocityNavigator v4.2! 🎉**
